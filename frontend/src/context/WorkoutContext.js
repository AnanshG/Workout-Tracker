...
export const WorkoutContextProvider = ( {children })=>{             // here children is the props of the wrapped component , which is the app component in this case   , it used for providing context to the wrapped component
    const [state,dispatch] = useReducer( workoutsReducer , {workouts : null} );                          // useReducer is used for updating states , read it about in docs . Has two arguments one is the reducer function and the other is the initial state
